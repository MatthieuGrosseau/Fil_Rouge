...
<title>Formulaire Add cinema</title>
...
<body>
	...
	<section id="main">
		...
		<div id="formulaire_add_cinema">

			<form action="${pageContext.request.contextPath }/admin/AjouterCinema" method="POST">
							
				<div>
					<label for="noPersonne">Personne : </label>
					<select name="noPersonne" id="noPersonne">
							<c:forEach items="${listePersonnes}" var="p">
								<option value="${p.noPersonne}">${p.nom}</option>
							</c:forEach>
					</select>
				</div>
				<div>
